...
def generate_charts(output_dir: pathlib.Path, spendings_amount_source: AmountSource, timestamp: Union[str, None]):
...
# fetch from database
    ...
    amount_categories = spendings_amount_source.categories()
