...
from charts.amountsource import HoursOfWorkAmountSource
...
def generate_charts(output_dir: pathlib.Path, hoursofwork_amount_source: HoursOfWorkAmountSource, timestamp: Union[str, None]):
