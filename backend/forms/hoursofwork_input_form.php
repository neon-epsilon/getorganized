...
// Handle posted input
if ( !empty($_POST["hoursofwork_input_form_submit"]) )
{
...
$form = '
    ...
    <ul>
        ...
        <li>
            <label for="amount">Stunden:</label>
    ...
    <input class="form_button" type="submit" name="hoursofwork_input_form_submit" value="Speichern" />
    %s
    </form>
